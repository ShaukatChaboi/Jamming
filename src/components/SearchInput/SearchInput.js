    ...
    <>
      <div className="flex items-center flex-col mb-100  pt-40 mb-8">
        <input
          ...
          className="block flex-1 border-0 decoration-black bg-Jamming-textColor pl-1 text-Jamming-bgTextInput   border-white text-center text-lg my-6 py-2 px-0  w-72"
